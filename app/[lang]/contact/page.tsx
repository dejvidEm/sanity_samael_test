...
export async function generateMetadata({
  ...
  return {
    title: "Contact Us",
    description:
      "Get in touch with Samael Consulting. Send us a message or find our contact information.",
  };
}
...
export default async function Contact({
  ...
  return (
    <div className="container mx-auto px-4 py-16 max-w-6xl">
      <FadeIn>
        <h1 className="text-4xl md:text-5xl font-bold mb-12 text-center text-navy-900">
          {dict.contact.title}
        </h1>
      </FadeIn>
      ...
      <MotionSection className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <FadeIn
          direction="left"
          className="bg-gradient-to-br from-navy-400 to-navy-800 text-white rounded-xl p-8 shadow-lg"
        >
          <h2 className="text-2xl font-bold mb-6">{dict.contact.infoTitle}</h2>

          <div>
            <Image src={logo} alt="Samael Consulting" className="w-48 mb-4" />
          </div>
          <div className="space-y-6">
            <div className="flex items-start space-x-4">
              <Phone
                className="h-6 w-6 text-gold-500 flex-shrink-0 mt-1"
                aria-hidden="true"
              />
              <div>
                <h3 className="font-medium text-gold-500">
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <a
                  href="mailto:samaelconsulting@icloud.com"
